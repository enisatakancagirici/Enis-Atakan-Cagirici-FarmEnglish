...
export const QuizScreen = () => {
  ...
  if (quizFinished) {
    ...
    const hasHotCombo = maxCombo >= 8;
    const farmResultMessage = hasHotCombo
      ? '🔥 Combo eğlencesine kapıldın! Bildiklerin meyve, bilmediklerin tohum olarak ekildi. İstersen ritmi sürdür, istersen tarlada büyütmeye devam et.'
      : accuracy >= 70
        ? '🌱 Bildiklerin meyve, bilmediklerin tohum olarak ekildi. Haydi, bunları tarlanda büyüt!'
        : '🌱 Bildiklerin meyve, bilmediklerin tohum olarak ekildi. Şimdi tarlada çalışıp tohumları meyveye çevirme zamanı!';
